...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		<a class="navbar-brand" href="#">Temple Booking Admin Panel</a>
	...
	$('.tenPercent').click(function(event) {
		...
		$.ajax({
				...
				success: function (data) {
					// console.log(data);
					if(data.valid == false){
						$('#modal-message').find('.modal-body').text('Customer  is Already Refunded!');
						
					}else if(data.valid == true){
						showAllTransaction();
						$('#modal-message').find('.modal-body').text('Customer Refunded Successfully!');
					}
