...
<body style="background: linear-gradient(to bottom, #ff99ff 0%, #ffcccc 70%);">

<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Temple Booking</a>
    </div>
