...
<body style="background: linear-gradient(to bottom, #00ff99 0%, #66ff33 100%);">

<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">KC's Temple Booking</a>
    </div>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								SCHEDULE OF VISITING THE TEMPLE
							</div>
						</div>
					</div>
					<div class="col-md-3">
					...
					<div class="col-md-3">
						<div class="panel panel-success">
							<div class="panel-heading">
								<h3 class="panel-title">3. VISITER INFO
...
<div class="container-fluid">
	...
	<div class="col-md-4">
		<div class="alert alert-danger">
			...
			<strong>Message!</strong> Please review your visiter information.
			You cannot change your booking once you proceed. 
		</div>
		<div class="panel panel-default">
			<div class="panel-body">
			 <h2>
			 	<center>VISITER INFO</center>
			 </h2>
				<div class="container-fluid">
